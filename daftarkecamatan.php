...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="hero-unit">
		<h3>Data Kecamatan</h3><br/><br/>
		<a href="inputdatakecamatan.php" ><img src="images/add.png" /> Tambah Kecamatan</a><br/><br/>
		...
		?>
				<tr>
					...
					<td>
						<a href="updatekecamatan.php?id=<?php echo $id; ?>"><img height="40" width="40" src="images/update.png"  title="update" /></a>
						<a href="hapuskecamatan.php?id=<?php echo $id; ?>"><img height="40" width="40" src="images/delete.png"  title="hapus" /></a>						
					</td>
				</tr>
		<?php
				$i++;
